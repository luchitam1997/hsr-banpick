...
const defaultOrders: Order[] = [
  { team: "blue", order: SelectType.BAN },
  { team: "red", order: SelectType.BAN },
  { team: "blue", order: SelectType.PICK },
  { team: "red", order: SelectType.PICK },
  { team: "red", order: SelectType.PICK },
  { team: "blue", order: SelectType.BAN },
  { team: "blue", order: SelectType.PICK },
  { team: "red", order: SelectType.BAN },
...
export function CreateForm() {
  ...
  const onBackClick = () => {
    setRoomData({
      ...roomData,
      pickBanOrder: roomData.pickBanOrder.slice(0, -1),
    });
  };
          ...
          <div className="flex gap-4">
            <div className="basis-1/3 flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <button
                  type="button"
                  className="w-full bg-gray-500 text-primary rounded-md py-2"
